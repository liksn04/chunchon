...
export const people: Person[] = [
  ...
  },
  {
    id: 'paik-sunyup',
    name: '백선엽',
    rankRole: '준장 · 국군 제1사단장',
    faction: 'ROK',
    bio: '1950년 8~9월 제1사단을 지휘해 유학산–다부동–가산 방어선을 유지했다. 전선이 흔들린 국면에 지휘부를 전방으로 옮겨 병력을 수습하고 미군 증원부대와 반격을 조정했다. 다부동 방어 뒤 평양 진격을 지휘했으며 전쟁 중 대한민국 최초의 대장과 육군참모총장에 올랐다. 전방 돌격 독려의 구체적 문구는 자신의 회고록과 후대 전승에 주로 근거한다.',
  },
  {
    id: 'kim-jeomgon',
    name: '김점곤',
    rankRole: '중령 · 국군 제1사단 제12연대장',
    faction: 'ROK',
    bio: '다부동 전투에서 제12연대를 지휘해 수암산·유학산 고지군의 주저항선을 맡았다. 반복되는 피탈과 역습 속에서 소부대 특공과 국지 반격을 운용하며 북한군의 다부동 도로축 접근을 지연시켰다. 이후 평양 진격에도 참가했고 전역 뒤 군사학자와 교수로 활동했다.',
  },
  {
    id: 'john-michaelis',
    name: '존 H. 마이켈리스',
    rankRole: '대령 · 미 제27보병연대장',
    faction: 'ROK',
    bio: '8월 17일 대구 북방으로 긴급 투입된 미 제27보병연대를 지휘했다. M26 전차와 포병·대전차화기를 결합해 다부동 도로축을 반격하고 천평계곡의 반복 야간 기갑전을 방어했다. 이 부대의 전투가 미군 전사에서 “Bowling Alley”로 기록됐다.',
  },
];
