...
export const eventLabels: Record<string, MapLabelPlacement> = {
  ...
  'yuhaksan-839': { text: '유학산 839고지 공방', dx: -22, dy: -22, anchor: 'end', leader: true, showAtAll: true },
  'tabudong-breach': { text: '다부동 돌파 위기', dx: 22, dy: -20, anchor: 'start', leader: true, showAtAll: true },
  'daegu-shelling': { text: '대구역 피탄', dx: 18, dy: -16, anchor: 'start', leader: true, showAtAll: false },
  'bowling-alley-opening': { text: '미 27연대 반격', dx: 22, dy: -18, anchor: 'start', leader: true, showAtAll: false },
  'bowling-alley-night-battles': { text: '볼링장 야간 전차전', dx: 24, dy: 24, anchor: 'start', leader: true, showAtAll: true },
  ...
  'counteroffensive': { text: '9.16 반격 전환', dx: 22, dy: -22, anchor: 'start', leader: true, showAtAll: true },
...
export const movementLabels: Record<string, MapLabelPlacement> = {
  'nk-3div-south': { text: '제3사단 서부 압박', showAtAll: false, showPathAtAll: true, dx: -8, dy: -12, anchor: 'end' },
  'nk-13div-corridor': { text: '제13사단 주공', showAtAll: true, showPathAtAll: true, dx: 10, dy: -12, anchor: 'start' },
  'nk-15div-yuhak': { text: '제15사단 동측 공격', showAtAll: false, showPathAtAll: true, dx: 10, dy: -10, anchor: 'start' },
  'nk-armor-bowling': { text: 'T-34 돌파축', showAtAll: true, showPathAtAll: true, dx: 10, dy: 16, anchor: 'start' },
  'us-27-counterattack': { text: '미 27연대 반격', showAtAll: true, showPathAtAll: true, dx: -10, dy: -14, anchor: 'end' },
  ...
  'rok-breakout': { text: '9.16 북진 반격', showAtAll: true, showPathAtAll: true, dx: 10, dy: -14, anchor: 'start' },
  'nk-general-withdrawal': { text: '북한군 철수', showAtAll: false, showPathAtAll: true, dx: -10, dy: 15, anchor: 'end' },
};
...
export const terrainPointLabels: Record<string, MapLabelPlacement> = {
  ...
  dabudong: { text: '다부동', dx: 16, dy: -14, anchor: 'start', leader: true },
  ...
  yuhaksan: { text: '유학산 839', dx: -18, dy: -16, anchor: 'end', leader: true },
  gasan: { text: '가산 902', dx: 16, dy: -12, anchor: 'start', leader: true },
  ...
  cheonpyeong: { text: '천평계곡·볼링장', dx: 16, dy: 18, anchor: 'start', leader: true },
...
export const terrainContours: Record<string, TerrainContour> = {
  yuhaksan: { rxDeg: 0.055, ryDeg: 0.032, rings: 5, rotate: -18 },
  gasan: { rxDeg: 0.065, ryDeg: 0.038, rings: 5, rotate: 14 },
  suamsan: { rxDeg: 0.038, ryDeg: 0.023, rings: 4, rotate: -8 },
  hill328: { rxDeg: 0.030, ryDeg: 0.019, rings: 3, rotate: 12 },
  hill373: { rxDeg: 0.028, ryDeg: 0.018, rings: 3, rotate: -12 },
};
...
export const terrainLineLabels: Record<string, MapLabelPlacement> = {
  ...
  'daegu-dabudong-road': { text: '상주–다부동–대구 축', dx: 10, dy: -10, anchor: 'start' },
